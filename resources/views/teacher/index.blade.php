                    ...
                    <div class="col-sm-3">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ml-auto"><span class="counter text-success">{{$courses}}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ml-auto"><span class="counter text-purple">{{$students}}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Files Uploaded</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                    <div id="sparklinedash2"><canvas width="67" height="30"
                                            style="display: inline-block; width: 67px; height: 30px; vertical-align: top;"></canvas>
                                ...
                                <li class="ml-auto"><span class="counter text-purple">{{$uploadCount}}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
