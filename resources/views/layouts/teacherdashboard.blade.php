                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('profile.teacher', ['id'=> Auth::user()->id]) }}"
                                aria-expanded="false">
                        ...
                        <hr>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('upload',auth()->user()->id) }}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            ...
                            href="{{route('upload.file')}}"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Upload Lecture Files</span>
                            </a>
                        </li>                        
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" 
                            href="{{route('messages.teacher')}}"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
